...
func (a *AuthUseCase) GetAllUsers(ctx context.Context, limit, offset int) ([]entity.User, error) {
	return a.repo.GetAll(ctx, limit, offset)
}

func (a *AuthUseCase) GetUserByID(ctx context.Context, id int64) (*entity.User, error) {
	return a.repo.GetByID(ctx, id)
}

func (a *AuthUseCase) DeleteUser(ctx context.Context, id int64) error {
